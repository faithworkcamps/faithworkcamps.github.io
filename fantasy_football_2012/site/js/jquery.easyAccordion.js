...
(function(jQuery) {
	...
	this.each(function() {
		...
		jQuery.fn.setVariables = function() {
			...
			ddWidth = dlWidth - (dtWidth*slideTotal) - (jQuery(this).find('dd').outerWidth(true)-jQuery(this).find('dd').width(680));
			ddHeight = dlHeight - (jQuery(this).find('dd').outerHeight(true)-jQuery(this).find('dd').height(412));
		};
		...
		if (jQuery.browser.mozilla){ var dtTop = dlHeight - 0; var dtOffset = - 20; /* FF */ }
