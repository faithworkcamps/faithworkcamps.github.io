...
//If you want to host your own files copy these files and re-link to your hosting site
	...
	var habChatIconOnline = "http://www.habman.com/mfl/images/chatonline.png";
	var habChatIconOffline = "http://www.habman.com/mfl/images/chatoffline.png";
	...
	var nflIconImage2 = "http://www.habman.com/mfl/images/nfl_spin.gif";	                            // TOS your nfl spin doesn't spin completely around, please upload mine
	...
	var nflVideoIcon = "http://www.habman.com/mfl/images/video.png";
	...
	var habChatJSFile = "http://www.habman.com/mfl/apps/js/habchat_mini2.js";
	...
	var habNewsBreakerJSFile = "http://www.habman.com/mfl/apps/js/habNewsBreakers.js";
	//The following file contains the borderless window popup script along with default CSS
	var habBorderlessWindowJSFile = "http://www.habman.com/mfl/apps/js/habmanBorderlessWindow.js";
	//PHP Files that you wouldn't normally host yourself
	var playerGameStatsPHP = "http://www.habman.com/mfl/apps/PlayerGameStats.php";
	var playerNewsPHP = "http://www.habman.com/mfl/apps/PlayerNews.php";
	var playerLoadingPHP = "http://www.habman.com/mfl/apps/PlayerLoading.php";
			...
			myTable = "<table class='cbsTeamLineup'>\n";
				for(var i=0;i<3;i++) {
						...
						while (playerList.indexOf(",")>0)	{
							...
							if(i!=2||(i==2&&playerID!=tiebreakingPlayer)) { // tiebreaking player also in bench list
								...
								if (includeProjections) {
									if (fsProjections[playerID]==undefined) var projections = ""; else { var projections = "<td class='cbsPlayerProjections'>"+parseFloat(fsProjections[playerID]).toFixed(precision)+"&nbsp;</td>"; tableProjTotals = tableProjTotals + parseFloat(fsProjections[playerID]); }
					...
					if (tableRows.length>0) {
						...
						if(includeProjections) {
							if(includeSOS) {
								var headerRow = "<tr class='lineupHeaderRow'><th colspan='2' class='lineupHeaderPlayer'>"+headerTitle+"</th><th colspan='3' class='lineupHeaderGames'>Games</th><th class='lineupHeaderProj'>Proj</th><th class='lineupHeaderActual'>Actual</th></tr>\n";
							} else {
							...
							if(selectBoxValue==""||selectBoxValue=="All"||selectBoxValue==xFid) {
								if(radioButtonValue2==-1 || radioButtonValue2==1 || (radioButtonValue2==2&&cbsRosterInfo[playerUpdateHistory[i][8]][x][2]==radioButtonValue2Str) ) {
									if(selectBoxValue2==""||selectBoxValue2=="All"||selectBoxValue2==playerUpdateHistory[i][8]) {
										...
										tempHTML = tempHTML + "   <td style='text-align:right;'>&nbsp;<a href='#1' title='View Player Stats' onclick='openStatsWindow(event,\""+playerUpdateHistory[i][8]+"\",\""+xFid+"\",\""+cbsCurrentWeek+"\")'>" + playerUpdateHistory[i][7] + "</a>&nbsp;&nbsp;</td>\n";
										tempHTML = tempHTML + "  </tr>\n";
									}
								}
							}
