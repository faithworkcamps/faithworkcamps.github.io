 ...
 ************************************************************
 * Modified By: Ela Govindasamy
 * Mail: ela.govindasamy@turner.com
 * Last modified date: 09/22/2009
 ************************************************************
 * jquery.innerfade.js
...
$.fn.cycle.updateActivePagerLink = function(pager, currSlide) {
	$(pager).find('li').removeClass('current').filter('li:eq('+currSlide+')').addClass('current');
};
